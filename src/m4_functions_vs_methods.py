...
def try_methods_and_functions():
    rochelia = rg.SimpleTurtle ('triangle')
    rochelia.pen = rg.Pen('blue', 5)
    rochelia.backward(150)
    rochelia.speed = 1
    draw_many_squares(rochelia, 2, 100, 30)
    rochelia.speed = 5
    rochelia.pen = rg.Pen ('red',5)
    draw_many_squares(rochelia, 10, 50, 15)
    rochelia.speed = 100
    rochelia.pen = rg.Pen('red', 35)
    draw_many_squares(rochelia, 8, 300, 60)
    rochelia.pen = rg.Pen('black', 3)
    rochelia.backward(200)
    rochelia.draw_circle(30)
    rochelia.draw_square(50)
